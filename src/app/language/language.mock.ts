...
export class LanguageServiceMock {
    ...
    public texts: any = {
        ...
        about: {
            title: 'About Me',
            content: [
                'Hi, my name is Eskinder and I am a Full-Stack Web Developer. I combine my knowledge and experience in order to develop professional web applications. I use the best practice to produce a clean code that is easy to debug and maintain.<br> I have a passion for web development and continue to learn the latest technological advancements.'
            ],
            button: {
                title: 'Download CV',
                tooltip: 'Download CV'
